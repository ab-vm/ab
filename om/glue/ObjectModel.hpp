...
public:
	/**
	 * Initialize the receiver, a new instance of GC_ObjectModel. An implementation of this
	 * method is required. Object models that require initialization after instantiation should
	 * perform this initialization here. Otherwise, the implementation should simply return
	 * true.
	 *
	...
	/**
	 * Tear down the receiver. A (possibly empty) implementation of this method is required. Any
	 * resources acquired for the object model in the initialize() implementation should be
	 * disposed of here.
	 */
	 ...
	 */
	MMINLINE void setObjectSizeAndFlags(
		omrobjectptr_t objectPtr, uintptr_t size, uintptr_t flags) {
