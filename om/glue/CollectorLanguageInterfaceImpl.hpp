...
public:
	...
	virtual MM_ConcurrentSafepointCallback* concurrentGC_createSafepointCallback(
	...
	virtual bool concurrentGC_forceConcurrentKickoff(
	...
	virtual uintptr_t concurrentGC_collectRoots(
	...
	virtual void concurrentGC_concurrentScanningStarted(
		MM_EnvironmentStandard* env, bool isConcurrentScanningComplete) {
	}
	virtual bool concurrentGC_isConcurrentScanningComplete(MM_EnvironmentBase* env) {
		return true;
	}
	virtual uintptr_t concurrentGC_reportConcurrentScanningMode(MM_EnvironmentBase* env) {
		return 0;
	}
	...
	virtual void scavenger_reportScavengeEnd(
	...
	virtual bool scavenger_scavengeIndirectObjectSlots(
		MM_EnvironmentStandard* env, omrobjectptr_t objectPtr);
	virtual void scavenger_backOutIndirectObjectSlots(
		MM_EnvironmentStandard* env, omrobjectptr_t objectPtr);
	...
	virtual void compactScheme_fixupRoots(
