...
private:
	 ...
	 * Derived from a sample run of Eclipse, which showed that the size necessary to have
	 * accurately report the top k elements was approximately linear.
	 */
...
public:
	...
	/* Creates a data structure which keeps track of the k most frequent class allocations
	 * (estimated probability of 90% of reporting this accurately (and in the correct order).
	 * The larger k is, the more memory is required
