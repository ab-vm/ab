#ifndef OM_INTERNAL_MAYBESTORAGE
#define OM_INTERNAL_MAYBESTORAGE

#include <Om/InPlace.hpp>
#include <Om/Nothing.hpp>
#include <Om/TypeTrait/Nullable.hpp>

#include <Om/Internal/Dummy.hpp>
#include <Om/Internal/SafeDestructor.hpp>
...
/// @see-also Om::TypeTrait::Nullable
...
public:
	...
	inline MaybeStorage(InPlace, Args&&... args) : storage_{std::forward<Args>(args)...}, isJust_{true} {
	}
...
#endif  // OM_INTERNAL_MAYBESTORAGE